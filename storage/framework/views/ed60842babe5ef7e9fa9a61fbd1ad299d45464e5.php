...
<div class="container">
    ...
    <form action="<?php echo e(route('appointment.store')); ?>" method="post"><?php echo csrf_field(); ?>
    <div class="card">
            ...
            <table class="table table-striped">
                <tbody>
                    <tr>
                        ...
                        <td><input type="checkbox" name="time[]" value="12.40m">12.40pm</td>
                    </tr>
                    <tr>
                        <th scope="row">8</th>
                    ...
                    <tr>
                        <th scope="row">11</th>
                        <td><input type="checkbox" name="time[]" value="4pm">4am</td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doctor\resources\views/admin/appointment/create.blade.php ENDPATH**/ ?>